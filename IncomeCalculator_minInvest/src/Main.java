...
public class Main {
    ...
    public static void main(String[] args) {
        double minPureForInvest = ((minInvestmentsAmount / (1 - mainTaxPercent)) + calculateFixedCharges()) / (1 - managerPercent);
        System.out.printf("Компания может инвестировать начиная с %.2f руб. дохода\n", minPureForInvest);
